...
variable "private_key_path" {
  description = "Path to the private SSH key file used for connecting to the nodes"
  type        = string
  default     = "/app/ssh-keys/private-key" 
}

variable "authorized_key_path" {
  description = "Optional authorized SSH authorized key path for the user"
  type        = string
}
